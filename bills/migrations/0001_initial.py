...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bills_bill', (
            ...
            ('message', self.gf('django.db.models.fields.TextField')(max_length=4000, null=True, blank=True)),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user', null=True, to=orm['auth.User'])),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('recipient_marked_paid', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('creator_marked_paid', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('bills', ['Bill'])

        # Adding model 'UserProfile'
        db.create_table('bills_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('bills', ['UserProfile'])

        # Adding M2M table for field friends on 'UserProfile'
        db.create_table('bills_userprofile_friends', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['bills.userprofile'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('bills_userprofile_friends', ['userprofile_id', 'user_id'])

        # Adding model 'Friendship'
        db.create_table('bills_friendship', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('bills', ['Friendship'])

        # Adding unique constraint on 'Friendship', fields ['to_friend', 'from_friend']
        db.create_unique('bills_friendship', ['to_friend_id', 'from_friend_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Friendship', fields ['to_friend', 'from_friend']
        db.delete_unique('bills_friendship', ['to_friend_id', 'from_friend_id'])

        # Deleting model 'Bill'
        db.delete_table('bills_bill')

        # Deleting model 'UserProfile'
        db.delete_table('bills_userprofile')

        # Removing M2M table for field friends on 'UserProfile'
        db.delete_table('bills_userprofile_friends')

        # Deleting model 'Friendship'
        db.delete_table('bills_friendship')
